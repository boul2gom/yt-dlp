...
```toml
[dependencies]
yt-dlp = { version = "2.8.0", features = ["hooks"] }
```
...
```toml
[dependencies]
yt-dlp = { version = "2.8.0", features = ["webhooks"] }
```
...
```toml
[dependencies]
yt-dlp = { version = "2.8.0", features = ["statistics"] }
```
...
```toml
[dependencies]
yt-dlp = { version = "2.8.0", features = ["live-recording"] }
```
...
```toml
[dependencies]
yt-dlp = { version = "2.8.0", features = ["live-streaming"] }
```
