...
```toml
[dependencies]
yt-dlp = { version = "2.8.2", features = ["hooks"] }
```
...
```toml
[dependencies]
yt-dlp = { version = "2.8.2", features = ["webhooks"] }
```
...
```toml
[dependencies]
yt-dlp = { version = "2.8.2", features = ["statistics"] }
```
...
```toml
[dependencies]
yt-dlp = { version = "2.8.2", features = ["live-recording"] }
```
...
```toml
[dependencies]
yt-dlp = { version = "2.8.2", features = ["live-streaming"] }
```
