...
```toml
[dependencies]
yt-dlp = { version = "2.1.0", features = ["hooks"] }
```
...
```toml
[dependencies]
yt-dlp = { version = "2.1.0", features = ["webhooks"] }
```
...
```toml
[dependencies]
yt-dlp = { version = "2.1.0", features = ["statistics"] }
```
